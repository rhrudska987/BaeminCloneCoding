...
public enum BaseResponseStatus {
    ...
    CANCELED_ORDER(false, 2005, "이미 취소된 주문입니다."),
    ...
    POST_ADDRESS_EMPTY_EMAIL(false, 2018, "주소를 입력해주세요."),
    POST_ADDRESS_INVALID_EMAIL(false, 2019, "주소 형식을 확인해주세요."),
    POST_REVIEW_EMPTY_COMMENT(false, 2020, "코멘트를 입력해주세요."),
