...
import com.example.demo.src.stores.StoresDao;
import com.example.demo.src.stores.StoresProvider;
...
public class CategoryService {
    ...
    @Autowired
    CategoryService(StoresDao storesDao, StoresProvider storesProvider){
